...
* Updated magic strings to constants to improve readability and maintainability. ([#5](https://github.com/vijayavelsekar/terraform-provider-vault/pull/5))
